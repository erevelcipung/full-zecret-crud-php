...
<head>
    ...
    <!-- Favicons -->
    <link rel="icon" href="assets/images/faviconz.ico">
...
<body class="text-center">
    ...
    <main class="form-signin">
        <form action="" method="POST">
            <img class="mb-4" src="assets/images/zlogo.png" alt="" width="72" height="57">
            ...
            <p class="mt-5 mb-3 text-muted">&copy; Zecret's <?= date('Y') ?></p>
        </form>
    </main>
