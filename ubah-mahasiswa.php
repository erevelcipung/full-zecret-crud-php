            ...
            <div class="mb-2">
                ...
                <form action="" method="post" enctype="multipart/form-data"> <!-- jika mewajibkan mengunggah sebuah file pake enctype -->
                    ...
                    <div class="row">
                        <div class="mb-3 col-6">
                            ...
                            <select name="prodi" id="prodi" class="form-control" required>
                                ...
                                <option value="Teknik Industri" <?= $prodi == '' ? 'selected' : null ?>>Teknik Industri</option>
                                <option value="Kesenian" <?= $prodi == '' ? 'selected' : null ?>>Kesenian</option>
                            </select>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <img src="assets/images/<?= $mahasiswa['foto']; ?>" alt="" class="img-thumbnail img-preview mt-2" width="100px">
                    </div>
